...
// int equations(double real, double imag, int MAX_iter, t_color *color)
// {
//     double Zr;
//     double Zi;
//     double tmp;
...
//     time_shift =  color->color_shift + i;
//     t = (double)time_shift / (double)MAX_iter; 
//     color->red = (int)(9 * (1 - t) * t * t * t * 200);
//     color->green = (int)(15 * (1 - t) * (1 - t) * t * t * 200);
//     color->blue = (int)(8.5 * (1 - t) * (1 - t) * (1 - t) * t * 200);
...
//             color.color = equations(real, imag, fractol->MAX_iter,&color);
//             my_mlx_pixel_put(fractol->img, x, y, color.color + fractol->color);
//             x++;
//         }
//         y++;
//     }
...
// void fractol_conection(var_t *fractol,int a)
// {
