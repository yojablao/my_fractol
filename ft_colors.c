...
/*   Updated: 2024/05/23 03:14:51 by yojablao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_color_max_iter(var_t fractol)
{
    fractol.colors.red = 255;
    fractol.colors.green = 255;
    fractol.colors.blue = 255;
    return ((fractol.colors.red << 16) | (fractol.colors.green << 8) | fractol.colors.blue);
}
...
int	ft_color3(var_t fractol, int iter)
{
	...
	t = (double)iter / (double)fractol.MAX_iter;
	fractol.colors.red = (int)(9 * (1 - t) * t * 255);
	fractol.colors.green = (int)(15 * (1 - t) * (1 - t) * t * t * 255);
	fractol.colors.blue = (int)(8.5 * (1 - t) * (1 - t) * (1 - t) * t * t * 255);
    return ((fractol.colors.green << 16) | (fractol.colors.blue << 8)
		|fractol.colors.red);
}
